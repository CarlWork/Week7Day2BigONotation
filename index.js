...
//no, It must scan through the whole array in worst case scenario
...
// ANSWER:
 ...
 const getNmbrsSqrdImprvd = numbers => {
  for (let i = 0; i < numbers.length; i++) {
...
// ANSWER: Yes, they both have 26 properties
...
// ANSWER: The letters object contains 26 properties and the split string stores an array of characters that makes the input constant. in the 2nd function, the letters object has a variable size depending on the unique characters in the input string. The for loop creates a new property when it encounters a new character.
